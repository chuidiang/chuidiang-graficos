...
public class CapaDibujo extends JComponent implements ObservadorRepintado
{
     ...
     * hará que los ObjetosGraficos se dibujen sobre esta EscalaGrafica, de
     * forma que el sistema de coordenadas y limites de dibujo serán los que
    ...
    /**
     * Añade el ObjetoGrafico que se le pasa a la lista de Objetos gráficos que
     * se pintarán sobre el Lienzo.
     * 
     * @param unObjeto
