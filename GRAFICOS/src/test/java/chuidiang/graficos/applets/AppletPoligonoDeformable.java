...
import chuidiang.graficos.objetos_arrastrables.PoligonoDeformable;
...
public class AppletPoligonoDeformable extends JApplet
{
    ...
    {
        JFrame v = new JFrame("Prueba polígnos deformables");
	 ...
	 * adecuada. Pone también una botonería con zoom de acercar y alejar
	 */
	public void init()
    {
     ...
     * le pasa. Será un applet o un frame.
    ...
    private static void creaComponentes (java.awt.Container contenedor)
	{
        ...
        // Se añaden cuatro polígonos de color al gráfico 
		...
		for (int i = 0; i < 4; i++)
		{
            ...
            // se hace que el polígono sea cerrado
			poligono.setCerrado(true);
            // Se pone el color del polígono
