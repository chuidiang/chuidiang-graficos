 ...
 * gráfico, pero no hace nada con el eje vertical, de forma que debe estar ya
...
public class Histograma extends AbstractObjetoGrafico
{
     ...
     * comenzaran en y=0.0 y llegarán hasta valores[i]. El Lienzo debe estar
     ...
     * 90% de su ancho máximo, para dejar un hueco entre unas y otras y con los
     * bordes del gráfico.
     */
    ...
    /** Coordenadas máximas y mínimas del Lienzo */
