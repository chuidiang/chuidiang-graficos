...
import chuidiang.graficos.objetos_graficos.GraficoSimbolos;
import chuidiang.graficos.objetos_graficos.Mano;

/**
 * Gráfico x/y con imágenes. Se pintan unos peces que se van moviendo por
 * pantalla.
 * 
 * @author Chuidiang
 */
public class AppletPeces extends AbstractAppletPruebaLienzo
{
    ...
    /**
     * Método start() del Applet.<br>
     * Carga las imágenes de peces, inizializa el lienzo de dibujo y lo mete
     * todo en el Applet.
     * Luego llama al método que arranca el hilo para mover los peces
     */
	public void init()
	{
		imagenes = new Image[numeroPeces];
