...
/**
 * Objeto gráfico que dibuja un array de puntos x,y.<br>
 */
        ...
        extends AbstractObjetoGrafico
{
   ...
   /**
    * Array con las imágenes que se quieren dibujar
    */
   ...
   /**
    * Devuelve el color en el que se están dibujando los puntos.<br>
    *
    * @return Color.<br>
    */
