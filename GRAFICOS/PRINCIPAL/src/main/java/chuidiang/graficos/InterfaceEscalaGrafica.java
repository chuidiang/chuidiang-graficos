...
public interface InterfaceEscalaGrafica
{
    ...
    /**
     * Devuelve los extremos del gráfico en coordenadas cartesianas de usuario.
     */
    public Rectangle2D dameExtremosCartesianos();

    /**
     * Devuelve los extremos del gráfico en las coordenadas de usuario propias
     * de la escala que se esté usando (cartesianas o polares)
     * @return Extremos
     */
    ...
    /**
     * Dibuja una línea uniendo consecutivamente los puntos x[i], y[i] del color
     * indicado.
     */
    ...
    /**
     * Dibuja un arco. La esquina es una de las esquinas del rectángulo
     * circunscrito a la circunferencia del arco. En ancho y alto son de este
     * rectángulo. El arcoInicial y arcoFinal son dónde comienza y termina el
    ...
    /**
     * Dibuja un arco relleno. La esquina es una de las esquinas del rectángulo
     * circunscrito a la circunferencia del arco. En ancho y alto son de este
     * rectángulo. El arcoInicial y arcoFinal son dónde comienza y termina el
     * arco de circunferencia, ambas en grados. El color es el color del arco.
     */
    ...
    /**
     * Dibuja un rectángulo relleno. Llama al método correspondiente de la clase
     * Graphics.
     */
    ...
    /**
     * Dibuja un rectángulo relleno 3D. Llama al método correspondiente de la
     * clase Graphics.
     */
    ...
    /**
     * Recoge observadores a los que se avisará cuando cambien los extremos del
     * gráfico (valores minimos y máximos a dibujar).
     */
