/*
 * Javier Abellán, 1 de Junio de 2004
 *
...
/**
 * Implementación de EscalaGrafica para proporcionar unas coordenadas de usuario
...
public class EscalaGraficaCartesiana implements InterfaceEscalaGrafica
{
	...
	/** Valor minimo de x que desea el usuario sobre el gráfico */
	...
	/**
	 * Añade un observador a un cambio en los limites de usuario. Cuando se
	 * cambien losG limites de usuario con tomaExtremos(), se avisará a los
	 * observadores.
	 * 
	 * @param unObservador
	 ...
	 * añadido previamente con anhadeObservador()
	 * 
	 * @param unObservador
	 ...
	 * pasan. La línea será del color indicado.
	 * 
	 * @param puntos
	 *            COMENTARIO.<br>
	 * @param color
	 ...
	 * @param ancho
	 *            Ancho del rectángulo, en coordenadas de usuario.<br>
	 * @param alto
	 *            Alot del rectángulo.<br>
	 * @param color
	...
	/**
	 * Dibuja un texto en la posición y del color indicado. La posición va en
	 * coordenadas de usuario.
	 * 
	 * @param posicion
	 *            COMENTARIO.<br>
	 ...
	 * Lienzo. No comprueba que los valores minimos sean mas pequeños que los
	 * máximos.
	 * 
	 * @param xMin
	 *            COMENTARIO.<br>
	...
	/**
	 * Guarda el ancho y alto del área de dibujo. Crea una imagen para dibujar
	 ...
	 * pixels. Se llama a este método después de darle a esta clase el ancho y
