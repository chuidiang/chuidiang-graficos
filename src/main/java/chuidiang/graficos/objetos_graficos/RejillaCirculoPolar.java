...
/**
 * Un circulo con escala, para gráficos polares.<br>
 */
public class RejillaCirculoPolar extends AbstractObjetoGrafico
{
	...
	/** Número de divisiones que se desean en el círculo */
	 ...
	 *            Número de divisiones para el círculo.<br>
	 * @param color
	...
	/**
	 * Dibuja el círculo en la escala que se le pasa.<br>
	 * 
	 * @param escala
	 ...
	 * 
	 * @return Longitud de la división
	 */
     ...
     * @param longitudDivisionSinTexto Longitud de la división.
     */
    ...
    /**
     * Devuelve el radio en unidades de usuario del círculo con escala que se
     * va a dibujar.
     * @return Radio.
     */
